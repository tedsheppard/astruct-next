        ...
        <div className="max-w-[1200px] mx-auto">
          ...
          <div className="mt-16 pt-16 border-t border-[#33312c]">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-10 lg:gap-0">
              {[
                { title: 'Auto-Classification', desc: 'Documents automatically categorised into 15+ construction document types.', icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="url(#g1)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><defs><linearGradient id="g1" x1="0" y1="0" x2="24" y2="24" gradientUnits="userSpaceOnUse"><stop stopColor="#7eb8da" /><stop offset="1" stopColor="#3d6b8e" /></linearGradient></defs><rect x="3" y="3" width="7" height="7" rx="1" /><rect x="14" y="3" width="7" height="7" rx="1" /><rect x="3" y="14" width="7" height="7" rx="1" /><rect x="14" y="14" width="7" height="7" rx="1" /></svg> },
                { title: 'Intelligent Search', desc: 'Vector embeddings and RAG across thousands of project documents and standards.', icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="url(#g2)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><defs><linearGradient id="g2" x1="0" y1="0" x2="24" y2="24" gradientUnits="userSpaceOnUse"><stop stopColor="#c4a7e0" /><stop offset="1" stopColor="#7b5ea7" /></linearGradient></defs><circle cx="11" cy="11" r="7" /><path d="m16 16 5 5" /><path d="M8 11h6" /><path d="M11 8v6" /></svg> },
                { title: 'Frontier AI Models', desc: 'The most advanced large language models for contractually precise drafting.', icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="url(#g3)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><defs><linearGradient id="g3" x1="0" y1="0" x2="24" y2="24" gradientUnits="userSpaceOnUse"><stop stopColor="#f0c27f" /><stop offset="1" stopColor="#c4883a" /></linearGradient></defs><path d="M12 2v4" /><path d="M12 18v4" /><path d="m4.93 4.93 2.83 2.83" /><path d="m16.24 16.24 2.83 2.83" /><path d="M2 12h4" /><path d="M18 12h4" /><path d="m4.93 19.07 2.83-2.83" /><path d="m16.24 4.76 2.83-2.83" /></svg> },
                { title: 'Platform Integrations', desc: 'Connects with Procore, Aconex, Asite and other construction platforms.', icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="url(#g4)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><defs><linearGradient id="g4" x1="0" y1="0" x2="24" y2="24" gradientUnits="userSpaceOnUse"><stop stopColor="#8ecfa0" /><stop offset="1" stopColor="#4a8a5c" /></linearGradient></defs><circle cx="5" cy="5" r="2" /><circle cx="19" cy="5" r="2" /><circle cx="5" cy="19" r="2" /><circle cx="19" cy="19" r="2" /><path d="M5 7v10" /><path d="M19 7v10" /><path d="M7 5h10" /><path d="M7 19h10" /></svg> },
                { title: 'Citation Verification', desc: 'Every AI response grounded in source documents with verifiable citations.', icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="url(#g5)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><defs><linearGradient id="g5" x1="0" y1="0" x2="24" y2="24" gradientUnits="userSpaceOnUse"><stop stopColor="#e8a0a0" /><stop offset="1" stopColor="#b05a5a" /></linearGradient></defs><path d="M9 12l2 2 4-4" /><path d="M4 6h16" /><path d="M4 10h16" /><path d="M4 14h10" /><path d="M4 18h8" /></svg> },
              ].map((item, i) => (
        ...
        <div className="max-w-[1200px] mx-auto">
          ...
          <div className="space-y-24">
            {[
              ...
              {
                title: 'Integrations',
                desc: 'Connect with Procore, Aconex, Asite, and other construction platforms. Sync correspondence and documents automatically.',
